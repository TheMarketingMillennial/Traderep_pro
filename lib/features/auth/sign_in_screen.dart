...
// Real Firebase email/password sign-in with forgot-password flow.
...
class _SignInScreenState extends State<SignInScreen> {
  ...
  Future<void> _signIn() async {
    ...
    // Demo mode — no Firebase credentials in this build
    ...
    if (!mounted) return;
    if (result.success) {
      // AppState.authStateChanges listener will handle navigation
...
// ─── Sign Up Screen ───────────────────────────────────────────────────────────
// (Imported from sign_up_screen.dart — referenced above)
